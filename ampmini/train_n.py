...
from ampmini.data_feature_n import Dataset
import os                                              
from Bio import SeqIO

def train(path1="",path2="", batch_size=64, learning_rate=0.001, num_epochs=10, save_model_dir="models_n/SequenceMultiTypeMultiCNN_1/AMP_1st"):
...
if __name__ == "__main__":
    train(path1="./data/AMP_1stage/AMPs_train_cdhit_40.fasta",path2="./data/AMP_1stage/nonAMPs_train_cdhit_40.fasta")
